...
@Component
public class OrderDelayConsumerListener extends ConsumeListener {

    public static final Logger log = LoggerFactory.getLogger(OrderDelayConsumerListener.class);
