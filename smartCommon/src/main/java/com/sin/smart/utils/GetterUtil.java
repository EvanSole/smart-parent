...
public class GetterUtil {
	...
	private static  final Logger _log = LoggerFactory.getLogger(GetterUtil.class);
	...
	public static boolean get(String value, boolean defaultValue) {
		...
		if (StringUtils.isNotEmpty(value)) {
			...
			return (BOOLEANS[0].equalsIgnoreCase(resultValue)
					|| BOOLEANS[1].equalsIgnoreCase(resultValue)
					|| BOOLEANS[2].equalsIgnoreCase(resultValue)
					|| BOOLEANS[3].equalsIgnoreCase(resultValue)
					|| BOOLEANS[4].equalsIgnoreCase(resultValue));
	...
	public static int get(String value, int defaultValue) {
		return StringUtils.isNotEmpty(value) ? Integer.parseInt(_trim(value)):defaultValue;
	}

	public static long get(String value, long defaultValue) {
		return StringUtils.isNotEmpty(value) ? Long.parseLong(_trim(value)):defaultValue;
	}

	public static short get(String value, short defaultValue) {
		return StringUtils.isNotEmpty(value) ? Short.parseShort(_trim(value)):defaultValue;
	}

	public static String get(String value, String defaultValue) {
		return  StringUtils.isNotEmpty(value) ? StringUtils.replace(value, StringPool.RETURN_NEW_LINE,
				StringPool.NEW_LINE) : defaultValue;
	}
